...
class OdometryMotionModel(Node):
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry, "hospital_bot_controller/odom", self.odomCallback, 10)
    ...
    def odomCallback(self, odom):
        ...
        self.last_odom_y = odom.pose.pose.position.y
        self.last_odom_theta = yaw
        self.pose_array_pub_.publish(self.samples)  # Argument added here
